"""
Django settings for dry_waterfall_45065 project.
...
ROOT_URLCONF = 'dry_waterfall_45065.urls'
...
WSGI_APPLICATION = 'dry_waterfall_45065.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_waterfall_45065 API",
    "DESCRIPTION": "API documentation for dry_waterfall_45065 App",
    "VERSION": "v1",
}
